...
Modern Javascript Software Linter For this project, we expect you to look at these concepts:

Modern Javascript Software Linter Install NodeJS 12.11.x (in your home directory):
